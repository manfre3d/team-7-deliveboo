<template>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>404</h1>
        <h2>UH OH! Sembra che ti sia perso.</h2>
        <p>La pagina che stai cercando non esiste.
         Come sei arrivatò qua è un mistero. Ma puoi sempre cliccare sul pulsante qua sotto per ritornare alla homepage.
        </p>
        <!-- <button class="btn green">HOME</button> -->
        <router-link :to="{ name: 'Home' }" class="btn green">HOME</router-link>
      </div>
    </div>
  </div>
</template>
...
.container {
  min-height: calc(100vh - 185.391px);
  display: flex;
}
html,
body {
